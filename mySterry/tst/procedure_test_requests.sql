...
begin
  ...
  set v_json = trim( left( v_sterry_json_data, 8192 ) );
  ...
  call mytestorproxy.api_testor_same( p_token, v_test_id, v_suite_id, v_case_id, 'json_data.1', sterry_escape( v_json ), sterry_escape( '{\"n\":2}' ) );
